 ...
 * request log.
 */
export declare function makeMiddleware<LoggerType>(projectId: string, makeChildLogger: (trace: string) => LoggerType, emitRequestLog?: (httpRequest: CloudLoggingHttpRequest, trace: string) => void): (req: ServerRequest, res: http.ServerResponse, next: Function) => void;
